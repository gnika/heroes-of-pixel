...
Game.defineImages = function(){
	...
	return [
		...
		Loader.loadImage('no_fer', 'assets/menu/no_ironpowder.png'),
		Loader.loadImage('cuir', 'assets/menu/cuir.png'),
		Loader.loadImage('culture_mais', 'assets/menu/corn_batiment.png'),
		Loader.loadImage('culture_cochon', 'assets/menu/cochon_batiment.png'),
		Loader.loadImage('vigne', 'assets/menu/raisin.png'),
		Loader.loadImage('no_vigne', 'assets/menu/no_raisin.png'),
		Loader.loadImage('mais', 'assets/menu/corn.png'),
		Loader.loadImage('no_mais', 'assets/menu/no_corn.png'),
		Loader.loadImage('no_ble', 'assets/menu/no_ble.png'),
		...
		Loader.loadImage('no_argile', 'assets/menu/no_argile.png'),
		Loader.loadImage('bijoux', 'assets/menu/bijoux.png'),
		Loader.loadImage('culture_ble', 'assets/menu/ble_batiment.png'),
		Loader.loadImage('brique', 'assets/menu/brique.png'),
		Loader.loadImage('cochon', 'assets/menu/cochon.png'),
		Loader.loadImage('no_cochon', 'assets/menu/no_cochon.png'),
		...
		Loader.loadImage('no_or', 'assets/menu/no_or.png'),
		Loader.loadImage('poterie', 'assets/menu/poterie.png'),
		Loader.loadImage('planche', 'assets/menu/planche.png'),
		Loader.loadImage('culture_raisin', 'assets/menu/raisin_batiment.png'),
		...
		Loader.loadImage('no_pierre', 'assets/menu/no_pierre.png'),
		Loader.loadImage('action', 'assets/menu/action.png'),
		Loader.loadImage('construire', 'assets/menu/hammer.png'),
		
		Loader.loadImage('3', 'assets/3.png'),
